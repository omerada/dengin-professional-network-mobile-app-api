...
export const ENV = {
  ...
  API_BASE_URL:
    expoConfig.API_BASE_URL || process.env.EXPO_PUBLIC_API_BASE_URL || 'http://192.168.1.100:8080', // Your host machine IP
  WS_URL: expoConfig.WS_URL || process.env.EXPO_PUBLIC_WS_URL || 'ws://192.168.1.100:8080/ws',
