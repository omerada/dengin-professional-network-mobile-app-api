package com.dengin.identity.infrastructure.storage;
...
public class ProfileImageS3Service {
    ...
    private String presignedUrlHost; // Override for mobile access (e.g., http://192.168.1.105:4566)
    ...
    private String getCloudFrontUrl(String s3Key) {
        if (cloudFrontDomain != null && !cloudFrontDomain.isBlank()) {
            ...
            if (presignedUrlHost != null && !presignedUrlHost.isBlank()) {
                // LocalStack path-style URL: http://192.168.1.105:4566/bucket/key
