package com.meslektas.messaging.api;

import com.meslektas.common.api.ApiResponse;
import com.meslektas.common.storage.S3PresignedUrlService;
...
import com.meslektas.messaging.application.service.ConversationService;
 ...
 * - POST /api/messages/attachments/upload-url - Get presigned URL for attachment upload
...
public class ConversationController {
    ...
    @Operation(
        ...
        description = "Returns user's conversations sorted by most recent message. Includes last message preview and unread count.",
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(schema = @Schema(implementation = ConversationListResponse.class))
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "401",
    ...
    @Operation(
        ...
        description = "Returns messages in a conversation with pagination. Oldest messages first for chat view.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
    ...
    @Operation(
        ...
        description = "Full-text search across all user's messages. Results are ranked by relevance.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            ...
            content = @Content(schema = @Schema(implementation = MessageSearchResponse.class))
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
    ...
    public ResponseEntity<ApiResponse<MessageSearchResponse>> searchMessages(
            ...
            @Parameter(description = "Filter messages sent after this date (ISO 8601)") 
            @RequestParam(required = false) LocalDateTime fromDate,
            @Parameter(description = "Filter messages sent before this date (ISO 8601)") 
    ...
    @Operation(
        ...
        description = "Sends a message to another user. Creates conversation if not exists. Only verified users can send messages.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request (empty content, content too long)"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "401",
            description = "Unauthorized - Invalid or missing token"
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - User not verified or blocked"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
    ...
    @Operation(
        ...
        description = "Soft-deletes a message. Only the sender can delete their message.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "403",
            description = "Forbidden - User is not the sender"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
    ...
    @Operation(
        ...
        description = "Generates a presigned S3 URL for direct client-side upload of message attachments. " +
                     "Only image files (JPEG, PNG, GIF, WebP) up to 10MB are allowed.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request (file too large, unsupported format)"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "401",
            description = "Unauthorized - Invalid or missing token"
