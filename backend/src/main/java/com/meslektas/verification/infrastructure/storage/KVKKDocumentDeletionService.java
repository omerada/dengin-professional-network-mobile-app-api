package com.meslektas.verification.infrastructure.storage;
...
public class KVKKDocumentDeletionService {
    ...
    @Async
    public void onVerificationApproved(com.meslektas.verification.domain.event.VerificationAutoApprovedEvent event) {
    ...
    @TransactionalEventListener(phase = TransactionPhase.AFTER_COMMIT)
    @Async
    public void onVerificationRejected(com.meslektas.verification.domain.event.VerificationAutoRejectedEvent event) {
