...
import com.meslektas.social.application.service.FollowService;
...
public class FollowController {
    ...
    @Operation(
        ...
        description = "Follows another user. Idempotent operation - following same user twice has no effect.",
    ...
    @ApiResponses(value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "400",
            description = "Invalid request - Can't follow self or blocked user"
        ),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "404",
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "429",
            description = "Too many requests - Rate limit exceeded (60 follows/hour)"
        )
    })
    ...
    @Operation(
        ...
        description = "Unfollows a user. Idempotent operation - unfollowing same user twice has no effect.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
    ...
    @Operation(
        ...
        description = "Returns list of user IDs who follow this user",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
    ...
    public ResponseEntity<ApiResponse<List<UserFollowDto>>> getFollowers(
        ...
        log.info("GET /api/users/{}/followers - requesterId: {}", userId, currentUser.getId());
        
        List<UserFollowDto> followers = followService.getFollowers(userId);
        
        log.info("Followers retrieved - userId: {}, followerCount: {}", userId, followers.size());
    ...
    @Operation(
        ...
        description = "Returns list of user IDs that this user follows",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
    ...
    public ResponseEntity<ApiResponse<List<UserFollowDto>>> getFollowing(
        ...
        log.info("GET /api/users/{}/following - requesterId: {}", userId, currentUser.getId());
        
        List<UserFollowDto> following = followService.getFollowing(userId);
        
        log.info("Following retrieved - userId: {}, followingCount: {}", userId, following.size());
