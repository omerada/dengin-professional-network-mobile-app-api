...
class FeedControllerTest {
    ...
    class GetFeedTests {
        ...
        void shouldGetPersonalizedFeed() throws Exception {
            ...
            when(feedService.getFeed(eq(1L), isNull(), eq(20)))
                    .thenReturn(feed);
        ...
        void shouldGetFeed_WithProfessionFilter() throws Exception {
            ...
            when(feedService.getFeed(eq(1L), eq(professionFilter), eq(20)))
                    .thenReturn(feed);
            ...
            verify(feedService).getFeed(1L, 10L, 20);
        }
        ...
        void shouldGetFeed_WithCustomLimit() throws Exception {
            ...
            when(feedService.getFeed(eq(1L), isNull(), eq(limit)))
                    .thenReturn(feed);
            ...
            verify(feedService).getFeed(1L, null, 10);
        }
        ...
        void shouldCapLimitAt50() throws Exception {
            // Given
            when(feedService.getFeed(eq(1L), isNull(), eq(50)))
                    .thenReturn(List.of());
            ...
            verify(feedService).getFeed(1L, null, 50);
        }
