package com.dengin.messaging.application.service;
...
import com.dengin.messaging.application.dto.ConversationListResponse;
import com.dengin.messaging.application.dto.MessageListResponse;
...
import com.dengin.messaging.domain.repository.ConversationRepository;
import com.dengin.social.domain.repository.BlockRepository;
...
class ConversationServiceTest {
        ...
        class SendMessageTests {
                ...
                void shouldSendMessageSuccessfully() {
                        ...
                        User recipientWithId = createVerifiedUser(RECIPIENT_ID, "recipient@test.com", "Recipient",
                                        "Test");
        ...
        class MarkMessagesReadTests {
                ...
                void shouldMarkMessagesAsRead() {
                        ...
                        // When
                        Long otherParticipantId = conversationService.markMessagesAsRead(command, RECIPIENT_ID);

                        // Then
                        assertThat(otherParticipantId).isEqualTo(SENDER_ID);
                        verify(conversationRepository).save(any(Conversation.class));
                        verify(eventPublisher).publishEvents(any());
                }
